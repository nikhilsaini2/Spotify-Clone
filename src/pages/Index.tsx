        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div
                key={index}
                className={`spotify-card bg-gradient-to-br ${playlist.gradient} relative overflow-hidden`}
              >
                <div className="p-6">
                ...
                <div className="absolute -bottom-2 -right-2 w-24 h-24 bg-white bg-opacity-10 rounded-full transform rotate-12"></div>
              </div>
            ))}
          </div>
        </section>
